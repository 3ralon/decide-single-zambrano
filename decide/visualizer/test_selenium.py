...
class VisualizerTestCase(StaticLiveServerTestCase):
    ...
    def test_votacion_abierta(self):
        ...
        self.assertTrue(len(self.driver.find_elements(By.ID, "app-visualizer")) == 1)
        self.assertTrue(len(self.driver.find_elements(By.ID, "voting-open")) == 1)  # Verifica si votación abierta (si esta bierta da 1)
    ...
    def test_votacion_no_empezada(self):
        ...
        self.assertTrue(len(self.driver.find_elements(By.ID, "app-visualizer")) == 1)
        self.assertTrue(len(self.driver.find_elements(By.ID, "voting-not-started")) == 1)  # Verifica q votación no comenzado